...
public class BahaMTest extends BaseTest {
    ...
    public void testTC_001_002_newFreestyleItem_negative() {
        ...
        getDriver().findElement(By.id(itemNameField)).sendKeys("!");
        getDriver().findElement(By.xpath(freestyleProjectButton)).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(itemNameInvalid_message)));
        Assert.assertEquals(getDriver().findElement(By.id(itemNameInvalid_message)).getText(),
