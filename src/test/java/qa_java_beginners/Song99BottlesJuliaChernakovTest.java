...
public class Song99BottlesJuliaChernakovTest extends BaseTest {
    ...
    public void testSongLyricsText() {
        ...
        getDriver().findElement(By.xpath("//body/div[@id='wrap']/div[@id='navigation']/ul[@id='submenu']/li/" +
                "a[@href='lyrics.html']")).click();

        String[] textArray = new String[100];
        for (int i = 0; i < textArray.length; i++) {
            int index = i + 1;
            textArray[i] = getDriver()
