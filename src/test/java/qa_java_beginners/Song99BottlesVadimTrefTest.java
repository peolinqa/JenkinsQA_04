...
public class Song99BottlesVadimTrefTest extends BaseTest {
    ...
    public void testLyricTextSong99Bottles() {
        ...
        String[] songTextArr = new String[100];
        String actualResult = "";
        for(int i = 0; i < songTextArr.length; i++){
            int index = i + 1;
            songTextArr[i] = getDriver().findElement(
                    By.xpath("//div[@id='main']/p[" + index + "]")).getText();
            actualResult += songTextArr[i];
        }
