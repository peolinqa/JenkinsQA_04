...
public class Song99BottlesOksanaBakatova extends BaseTest {
    ...
    public void testSongLyricText (){
        ...
        getDriver().get("https://99-bottles-of-beer.net/lyrics.html");
        getDriver().findElement(By.xpath("//a[@href = 'lyrics.html']")).click();

        String [] pText = new String [100];
        for (int i = 0; i < pText.length; i++) {
            int index = i + 1;
            pText[i] = getDriver().findElement(By.xpath("//div[@id= 'main']/p[" + index + "]")).getText();
        }
