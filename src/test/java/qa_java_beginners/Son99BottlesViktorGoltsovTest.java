...
public class Son99BottlesViktorGoltsovTest extends BaseTest {
    @Test
    public void testSongLyricTest() {

        String expectedRresult = "99 bottles of beer on the wall, 99 bottles of beer.\n" +
        ...
        for (int i = 0; i < pText.length; i++) {
            ...
            pText[i] = getDriver().findElement(By.xpath(
                    "//body/div[@id='wrap']/div[@id='main']/p[" + index + "]")).getText();
        }
