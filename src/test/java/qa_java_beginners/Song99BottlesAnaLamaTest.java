...
public class Song99BottlesAnaLamaTest extends BaseTest {
    ...
    private String createLyrics() {
        ...
        final String WALL_DOT = " bottles of beer on the wall.";
